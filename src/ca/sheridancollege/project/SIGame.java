...
public class SIGame extends Game {
    ...
    /**
     * Constructs a new game given the name and the view where the
     * interaction with payers occur.
     * 
    ...
    */
    private void initialize() {
        ...
        view.printMessage(String.format("%s", getName()));
    ...
    */
    private void printRoundWinnerMessage() {
        view.printMessage(String.format("%s you won this round!%n",
